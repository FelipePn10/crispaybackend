                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #666666; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                Estamos muito felizes em ter você conosco! Sua conta foi criada com sucesso e você já pode começar a explorar todos os nossos recursos.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px; background-color: #f8f9fa; border-radius: 8px; margin-bottom: 10px;">
                                        ...
                                        <p style="color: #666666; font-size: 14px; line-height: 1.5; margin: 0;">
                                            Adicione suas informações e personalize sua experiência
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background-color: #f8f9fa; padding: 30px 40px; text-align: center; border-top: 1px solid #e9ecef;">
                            ...
                            <p style="color: #999999; font-size: 12px; margin: 0;">
                                Você recebeu este email porque criou uma conta em nossa plataforma.
                            </p>
                        </td>
                    </tr>
                </table>
